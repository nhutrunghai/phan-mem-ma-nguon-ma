...
<!-- Mirrored from betacinemas.vn/gia-ve.htm by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Apr 2026 07:52:12 GMT -->
...
<meta name="og:url" content="https://betacinemas.vn/gia-ve/gia-ve-rap-beta-thai-nguyen.htm" /><meta name="og:type" content="article" /><meta name="og:title" content="Beta Cinemas - GIÁ VÉ RẠP BETA THÁI NGUYÊN" /><meta name="og:description" content="Beta Cinemas tự hào là cụm rạp chiếu phim mang đến trải nghiệm điện ảnh Hollywood với mức giá hợp lý nhất - chỉ từ 40.000/vé xem phim. Được trang bị hệ thống máy móc thiết bị hiện đại, khuôn viên giải trí kết hợp ẩm thực phong phú đa dạng từ nhiều quốc gia - Beta Cineplex đã và đang trở thành địa điểm giải trí lý tưởng cho các nhóm bạn trẻ và gia đình." /><meta name="og:image:url" content="https://files.betacorp.vn//cms/images/2024/04/03/ticket-144353-030424-88.png" /><meta name="og:site_name" content="Beta Cinemas" /><style>
        ...
        <div class="row">
            ...
            <div class="col-md-16 col-sm-16 additional-nav">
                <div class="pull-right padding-left-10">
                    ...
                    <a id="BodyContent_ctl00_ctl05_hlEn" onclick="changelang(&#39;eng&#39;);"><img src="{{ asset('web-home/assets/legacy-beta/Assets/Common/icons/united-kingdom.png') }}" class="img-responsive"/></a>
                </div>
    ...
    <div class="container">
        ...
        <div class="header-navigation pull-right font-transform-inherit">
            <ul>
                        ...
                        <li id="BodyContent_ctl00_ctl05_rptMenu2_liNoChild_0">
                            <a href="{{ route('schedule.index', [], false) }}">LỊCH CHIẾU THEO RẠP</a>
                        </li>
                    
                        
                        <li id="BodyContent_ctl00_ctl05_rptMenu2_liNoChild_1">
                            <a href="{{ route('movies.index', [], false) }}">PHIM</a>
                        </li>
                    
                        
                        <li id="BodyContent_ctl00_ctl05_rptMenu2_liNoChild_2">
                            <a href="{{ route('cinemas.info', [], false) }}">RẠP</a>
                        </li>
                    
                        
                        <li id="BodyContent_ctl00_ctl05_rptMenu2_liNoChild_3">
                            <a href="{{ route('prices.index', [], false) }}">GIÁ VÉ</a>
                        </li>
                    
                        
                        <li id="BodyContent_ctl00_ctl05_rptMenu2_liNoChild_4">
                            <a href="{{ route('promotions.index', [], false) }}">TIN MỚI VÀ ƯU ĐÃI</a>
                        </li>
                    
                        
                        <li id="BodyContent_ctl00_ctl05_rptMenu2_liNoChild_5">
                            <a href="{{ route('franchise.index', [], false) }}">NHƯỢNG QUYỀN</a>
                        </li>
                    
                        
                        <li id="BodyContent_ctl00_ctl05_rptMenu2_liNoChild_6">
...
<div id="popup_choosecinema" style="display: none;width: 700px; margin-top: -200px; background-color: #005198; border-radius: 30px !important">
    <div class="modal-body text-center">
        <div class="row">
            ...
            <div class="container">
              <div class="row">
            	<div id="BodyContent_ctl00_leftPanel" class="ecm-panel col-lg-16">
...
<div class="news-info margin-top-20 margin-sm-top-20 margin-xs-top-20">
    <div id="printContent">
        <div class="col-md-16 col-sm-16 col-xs-16">
            <div id="BodyContent_ctl00_ctl04_showImage" class="text-center" style="margin-bottom: 10px; text-align: center; display: none;">
                <a href='https://files.betacorp.vn/cms/images/2024/04/03/ticket-144353-030424-88.png' title="" class="swipebox">
                    <img src='https://files.betacorp.vn/cms/images/2024/04/03/ticket-144353-030424-88.png' class="img-responsive" style="display: initial;" /></a>
                <p style="font-style: italic"></p>
            </div>
            <br />
            <h3 class="no-margin">
                <span id="BodyContent_ctl00_ctl04_newsTitle">GIÁ VÉ RẠP BETA THÁI NGUYÊN</span>
            </h3>
            <div class="fb-like hidden-xs" data-href="https://betacinemas.vn/gia-ve/gia-ve-rap-beta-thai-nguyen.htm" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
            <h4>
        ...
        <div class="col-md-16 col-sm-16 col-xs-16 font-family-san font-14" id="divNewsDetails">
                    ...
                    <p><img alt="" src="https://files.betacorp.vn/cms/images/2024/04/03/bang-gia-ve-tn-ve-2d-va-3d-1920x2400-150958-030424-19.png" style="width: 100%; height: 100%;" /></p>
        ...
        <div class="col-md-16 col-sm-16 col-xs-16">
            <p class="pull-right">
                <strong>
                    <span id="BodyContent_ctl00_ctl04_lblTacgia"></span></strong>
                <span id="BodyContent_ctl00_ctl04_lblNguonThongTin"></span>
            </p>
        </div>
        <div class="col-md-16 col-sm-16 col-xs-16 ">
        ...
        <div id="BodyContent_ctl00_ctl04_newInfoComment">
    ...
    <div class="col-md-16 margin-bottom-35">
        <div class="fb-comments" data-href="https://betacinemas.vn/gia-ve/gia-ve-rap-beta-thai-nguyen.htm" data-numposts="5" data-width="auto" data-colorscheme="light"></div>
    </div>
</div>
</div>
              </div>
    ...
    <div style="float: left;">
        ...
        <div class="contact" style="float: left;">
            ...
            <p>
                ...
                <h6 class="no-margin font-12">Email: <a href="https://betacinemas.vn/cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="1a77716e5a787f6e7b7973747f777b69346c74">[email&#160;protected]</a></h6>
            </p>
            <p>
                <h5>LIÊN HỆ QUẢNG CÁO:</h5>
                <h6 class="no-margin font-12">Hotline: 0934 632 682 </h6>
                <h6 class="no-margin font-12">Email: <a href="https://betacinemas.vn/cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="4c2d280c2e29382d2b3e23393c623a22">[email&#160;protected]</a></h6>
            </p>
            <p>
                <h5>LIÊN HỆ HỢP TÁC KINH DOANH:</h5>
                <h6 class="no-margin font-12">Hotline: 1800 646420</h6>
                <h6 class="no-margin font-12">Email: <a href="https://betacinemas.vn/cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="70121113180408301215041117021f05005e061e">[email&#160;protected]</a></h6>
            </p>
        </div>
    </div>
